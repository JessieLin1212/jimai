<template>
    <div id="j-foot">
        <router-link to="/">
         ...
         <router-link to="/car">
            <p ref="car"><i class="iconfont icon-gouwuche"></i><span>购物车</span></p>
        </router-link>
        <router-link to="/my"> 
            <p ref="my"><i class="iconfont icon-wode2 j-footmy"></i><span>我的</span></p>
        </router-link>
    </div>
</template>
        ...
        mounted(){
                ...
                if(this.$router.history.current.path=='/'){
                    ...
                    this.$refs.index.classList.add('active');
                     ...
                     this.$refs.my.classList.add('active');
                }
